  ...
  Future<void> _openMessagesModal(BuildContext context) async {
    final threads = <_MessageThread>[
      const _MessageThread(
        ...
        subtitle: 'Support • Help center, refunds, and account issues',
        icon: Icons.support_agent_rounded,
        badge: '1',
      ),
      const _MessageThread(
        title: 'Petopia Official',
        subtitle: 'Store • Order updates and product questions',
        icon: Icons.storefront_outlined,
      ),
      const _MessageThread(
        title: 'FurCare Store',
        subtitle: 'Store • Grooming products and returns',
        icon: Icons.storefront_outlined,
      ),
      const _MessageThread(
        title: 'Happy Tails Shop',
        subtitle: 'Store • Shipping and availability',
        icon: Icons.storefront_outlined,
      ),
    ];
