...
class _SignupSellerPageState extends State<SignupSellerPage> {
  ...
  final _detailedProductsController = TextEditingController();
  ...
  void dispose() {
    ...
    _detailedProductsController.dispose();
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Grow your business and reach more pet lovers by joining as a seller.',
                    style: TextStyle(
                      color: _muted,
  ...
  String _stepLabel() {
    switch (_step) {
      ...
      case 2:
        return 'Step 2 of 3 - Business Details';
      default:
    ...
    return Column(
      children: [
        ...
        TextFormField(
          ...
          readOnly: true,
          onTap: () =>
              _pickAddress(_sellerAddressController, 'Select Complete Address'),
          decoration: _decoration(
            'Complete Address',
    ...
    return Column(
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          decoration: _decoration('Business Type'),
          items: const [
            DropdownMenuItem(
            ...
            DropdownMenuItem(
              ...
              child: Text('Individual / Freelancer'),
            ),
          ],
          onChanged: (value) => setState(() => _businessType = value),
          validator: (v) =>
              _step == 2 && v == null ? 'Business type is required.' : null,
        ),
        const SizedBox(height: 10),
        DropdownButtonFormField<String>(
          initialValue: _category,
          decoration: _decoration('Primary Category'),
          items: const [
            'Food & Treats',
            'Grooming & Hygiene',
            'Bedding & Housing',
          ...
          validator: (v) =>
              _step == 2 && v == null ? 'Category is required.' : null,
        ),
        const SizedBox(height: 10),
        TextFormField(
          controller: _detailedProductsController,
          minLines: 2,
          maxLines: 4,
          decoration: _decoration('Detailed Product Description'),
        ),
        const SizedBox(height: 10),
        TextFormField(
          ...
          decoration: _decoration('Business Address'),
          validator: (v) => _step == 2 && (v == null || v.isEmpty)
        ...
        TextFormField(
          ...
          decoration: _decoration('Years in Operation'),
        ),
        const SizedBox(height: 10),
        TextFormField(
  ...
  Future<void> _pickAddress(
    ...
    if (result != null && result.isNotEmpty) controller.text = result;
    ...
    showDialog<void>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const SingleChildScrollView(
          child: Text(
            'By creating a seller account, you agree to provide accurate business information, fulfill orders responsibly, and comply with Petopia marketplace policies.',
          ),
        ),
        actions: [
          TextButton(
  ...
  void _onPrimaryPressed() {
    ...
    if (_step == 2 && !_validateStep2Extra()) return;
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Seller sign-up submitted. Verification review is next.'),
      ),
    );
    ...
    Navigator.of(context).pushNamed(
      ...
      arguments: {
        ...
        'next': AppRoutes.sellerDashboard,
      },
    );
  }
