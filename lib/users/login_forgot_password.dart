...
class _LoginForgotPasswordPageState extends State<LoginForgotPasswordPage> {
  ...
  String? _validationFeedback(String email) {
    if (email.trim().isEmpty) return null;
    final regex = RegExp(r'^[^\s@]+@(gmail|yahoo)\.com$', caseSensitive: false);
  ...
  Future<void> _submit() async {
    ...
    Navigator.of(context).pushNamed(
      AppRoutes.resetCode,
      arguments: {'destinationLabel': _emailController.text.trim()},
    );
  }

  @override
  Widget build(BuildContext context) {
    final feedback = _validationFeedback(_emailController.text);
